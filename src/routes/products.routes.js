...
import { updateProducts02, createNewProductBodega, getProducts ,getProductById, deleteById, updateProducts, getProductsEstanteria} from "../controllers/product.controller"; 
const router = Router();
